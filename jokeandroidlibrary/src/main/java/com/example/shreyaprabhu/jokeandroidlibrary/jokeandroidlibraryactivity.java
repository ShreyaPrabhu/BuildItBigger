package com.example.shreyaprabhu.jokeandroidlibrary;
...
public class jokeandroidlibraryactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jokeandroidlibraryactivity);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings_androidLibrary) {
            return true;
        }
